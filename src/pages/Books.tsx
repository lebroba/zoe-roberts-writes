...
import LanguageAwareBookCover from "@/components/LanguageAwareBookCover";
    ...
    <Layout>
      <div className="bg-cream py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-playfair font-bold text-navy mb-8 text-center">{t('books.title')}</h1>
