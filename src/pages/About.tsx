      ...
      <div className="bg-cream py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-playfair font-bold text-navy mb-8 text-center">About Zoe Roberts</h1>
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <h2 className="text-2xl font-playfair font-bold text-navy mt-10 mb-4">Literary Journey</h2>
              ...
              <h2 className="text-2xl font-playfair font-bold text-navy mt-10 mb-4">Writing Process</h2>
              ...
              <h2 className="text-2xl font-playfair font-bold text-navy mt-10 mb-4">Personal Life</h2>
            ...
            <div className="mt-12 border-t border-gray-300 pt-12">
              <h2 className="text-2xl font-playfair font-bold text-navy mb-6 text-center">Connect with Zoe</h2>
