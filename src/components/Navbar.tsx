      ...
      <div className="border-t border-b border-soft-gold py-4">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="hidden md:flex items-center space-x-12">
            <Link to="/" className="nav-link text-base">{t('nav.home')}</Link>
            <Link to="/books" className="nav-link text-base">{t('nav.books')}</Link>
            <Link to="/freebies" className="nav-link text-base">{t('nav.freebies')}</Link>
            <Link to="/about" className="nav-link text-base">{t('nav.about')}</Link>
            <Link to="/contact" className="nav-link text-base">{t('nav.contact')}</Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="absolute z-50 bg-cream p-4 border-b border-soft-gold md:hidden w-full animate-fade-in">
          <div className="flex flex-col space-y-4">
            <Link to="/books" className="nav-link" onClick={toggleMenu}>{t('nav.books')}</Link>
            <Link to="/freebies" className="nav-link" onClick={toggleMenu}>{t('nav.freebies')}</Link>
