...
const FeaturedBooks = () => {
  // Updated featured books with only the children's book
  const featuredBooks = [
    {
      id: 1,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-gray-700">
            Discover Zoe Roberts' most celebrated work on growth mindset for tweens, helping young readers unlock their potential and develop confidence.
          </p>
        </div>
        
        <div className="grid grid-cols-1 gap-8 justify-center">
          {featuredBooks.map((book) => (
            <div key={book.id} className="flex flex-col items-center max-w-md mx-auto">
