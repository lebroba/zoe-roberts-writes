          ...
          once: true
            ...
            <div className="relative group">
              ...
              <div className="relative overflow-hidden rounded-lg transform hover:scale-[1.01] transition-all duration-500">
                <img alt="Zoe Roberts writing at her desk" className="relative z-10 rounded-lg shadow-lg max-w-full h-auto object-cover" src="/lovable-uploads/01348dfc-206d-4c88-9800-82a3c06ba3f5.png" />
